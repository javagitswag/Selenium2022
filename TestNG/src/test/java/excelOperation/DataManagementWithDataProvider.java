...
public class DataManagementWithDataProvider 
{
  ...
  public void f(String Runmode, String Browser,String UserName,String UserPassword,String ExceptedResult) 
  {
  ...
  public Object[][] getData() throws Exception 
  {
	  ExcelAPI e=new ExcelAPI("C:\\Users\\mama\\Desktop\\suitex.xlsx");	
		...
		String testCaseName = "TestA ";//TestB
		...
		for(int rNum=dataStartRowNum;rNum<dataStartRowNum+rows;rNum++)
		{
			for(int cNum=0;cNum<cols;cNum++ )
			{
				...
				data[dataRow][cols]=e.getCellData(sheetName, cNum, rNum);
			}	
			dataRow++;
		}
		return null;	  
